...
def showcalendar(request):
    try:
        ...
        return render(
            request, 'MonthlyCalendar.html', {
                'page_name': 'Monthly View', 'error_message': "You didn't enter year and month"},)
