...
class ConferenceRoom(models.Model):
    ...
    equipments_required = models.ManyToManyField(
        EquipmentsRequired, verbose_name=_('Equipments'), blank=True)
...
class BookConference(models.Model):
    ...
    name_of_meeting = models.CharField(
        _('Meeting About'),
        max_length=100,
        null=True,
        blank=True)
    requested_by = models.ForeignKey(
        ...
        related_name="%(app_label)s_%(class)s_requested_by",
        null=True)
    ...
    conference_room = models.ForeignKey(
        ...
        related_name="%(app_label)s_%(class)s_conference_room")
    reason_for_room = models.CharField(
        _('Reason for room'),
        choices=MEETING_TYPES,
        max_length=15)
    meeting_date = models.DateField(_('Meeting Date'))
    from_time = models.TimeField(
        _('Meeting Start Time'),
        null=True,
        blank=True)
    ...
    equipments_required = models.ManyToManyField(
        EquipmentsRequired, verbose_name=_('Equipments'), blank=True)
    client_food_arrangement = models.CharField(
        _('Food Needed'),
        choices=CLIENT_PROVISION,
        max_length=15,
        null=True,
        blank=True)
