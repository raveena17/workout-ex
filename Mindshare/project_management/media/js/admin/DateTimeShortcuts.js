...
var DateTimeShortcuts = {
    ...
    addCalendar: function(inp) {
		...
		label1.appendChild(document.createTextNode(gettext('[mm-dd-yyyy]')));
		...
		shortcuts_span.appendChild(document.createTextNode('\240'));
		shortcuts_span.appendChild(label1);
    ...
    handleCalendarCallback: function(num) {    
        return "function(y, m, d) {var selDt=new Date();selDt.setFullYear(y,m-1,d);frmt = formatDate(); DateTimeShortcuts.calendarInputs["+num+"].value = selDt.strfdate(frmt); document.getElementById(DateTimeShortcuts.calendarDivName1+"+num+").style.display='none';DateTimeShortcuts.calendarInputs["+num+"].focus();}";
    },
    handleCalendarQuickLink: function(num, offset) {
      ...
      frmt = formatDate();
      DateTimeShortcuts.calendarInputs[num].value = d.strfdate(frmt);
