    ...
    if request.method == 'POST':
        ...
        if request_form.is_valid() and schedules_form.is_valid():
            ...
            if request.user.has_perm(
                ...
                if is_approved:
                    email_message = "Project " + str(request_form.cleaned_data['name']) + ' was approved by ' + str(
                        request_form.cleaned_data['approved_by']) + ' on ' + str(schedules_form.cleaned_data['approved_date'])
                    ...
                    email_message = "Project " + str(request_form.cleaned_data['name']) + ' was Rejected by ' + str(
                        request_form.cleaned_data['approved_by']) + ' on ' + str(schedules_form.cleaned_data['approved_date'])
