...
#TEMPLATE_EMAILDIR =  PROJECT_ROOT + '/' + 'templates'
...
EMAIL_MESSAGE_TXT2 = 'asdasdasdasdasd'
...
SETTING_PATH = '' #'/home/username/projects/payit/apps/project_management/templates'
