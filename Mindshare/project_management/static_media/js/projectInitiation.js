...
$(document).ready(function(){    
    ...
    $('#cancel_bttop').click(function(){ window.location.href = '/projects/list/' });
    $('#cancel_bt').click(function(){ window.location.href = '/projects/list/' });
    ...
    $("[id ^='SaveAndContinue']").click(function(){$('#redirectionUrl').val('/projects/initiation/');});
    ...
    $('#DeleteAllMilestoneDetails').click(function(){
            ...
            $('#redirectionUrl').val('/projectsupdate/?ids='+$('#id_id').val());
    ...
    $('#DeleteAllTimeBasedDetails').click(function(){
        if (window.confirm('Are you sure you want to delete all time-based billing details ?'))
        {
            ...
            $('#redirectionUrl').val('/projects/update/?ids='+$('#id_id').val());
            changeFormsetDateFormat();
            $("form:first").submit();
        }
        });
	...
	function saveProject() { 
	   if(!isBetweenDate(document.getElementById("id_planned_start_date").value, document.getElementById("id_planned_end_date").value)) {
    		...
    		return false;
             ...
             document.program.action = '/projects/initiation/';
             return true;
       	}
}
